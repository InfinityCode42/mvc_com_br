    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configurações de exibição</h5>
          <p>Opções visual da dashboard.</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Corres da barra lateral</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Tipos de barra lateral</h6>
          <p class="text-sm">Escolha entre 2 tipos diferentes de barra lateral.</p>
        </div>
        <div class="d-flex">
